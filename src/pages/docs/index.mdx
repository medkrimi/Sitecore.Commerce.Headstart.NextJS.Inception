...
## Quick Start
----
1. Create an Order Cloud Marketplace instance (https://portal.ordercloud.io)
2. Using the Deploy Button below, you'll deploy on Vercel the Next.js project as well as connect it to your Sitecore Commerce Order Cloud sandbox.
...
4. Deploy your update on Vercel
